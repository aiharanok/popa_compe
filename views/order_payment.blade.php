...
{{ Form::open(array('url' => 'orderPaymentConfirm')) }}
    ...
    <input type="hidden" name="category_labels" value="{{$orders['category_labels']}}" />
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            {{ Form::submit('　　確認　　', array('class' => 'btn btn-primary center-block', 'name' =>'credit_confirm')) }}
        </div>
    </div>
